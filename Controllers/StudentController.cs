...
namespace basicStudent.Controllers
{
    ...
    {
        private string _connectionString = @"Data Source=DESKTOP-ONQCGNA\SQLEXPRESS;Initial Catalog = School; Integrated Security = True; Connect Timeout = 30; Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
